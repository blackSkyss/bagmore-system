        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorCode = table.Column<string>(type: "varchar(15)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstAddress = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    SecondAddress = table.Column<string>(type: "nvarchar(100)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DescribeProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DescribeProducts_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DescribeProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DescribeProducts_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingAddresses_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JwtId = table.Column<string>(type: "varchar(MAX)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Colors",
                columns: new[] { "Id", "ColorCode", "Name", "Status" },
                values: new object[,]
                {
                    { 1, "#ffffff", "White", 1 },
                    { 2, "#000000", "Black", 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DescribeProducts_ColorId",
                table: "DescribeProducts",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_DescribeProducts_ProductId",
                table: "DescribeProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DescribeProducts_SizeId",
                table: "DescribeProducts",
                column: "SizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingAddresses_IdUser",
